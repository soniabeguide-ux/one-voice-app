...
// dans l'application (1er janvier 2023).
const CONTENT_CUTOFF = "2023-01-01T00:00:00Z";
...
const PREACHERS = [
  ...
  },
  {
    ...
    messages: [
      { id: "m-wafo-6", videoId: "DHjAOiFSROo", title: "Le pouvoir de la décision !", theme: "Foi", publishedAt: "2026-01-21", durationSeconds: 2700, contentType: "predication" },
      { id: "m-wafo-7", videoId: "7swbFEmXeI8", title: "1er culte d'adoration — 11 janvier 2026 / Temple de la Foi", theme: "Foi", publishedAt: "2026-01-11", durationSeconds: 2700, contentType: "predication" },
      { id: "m-wafo-1", videoId: "4e0wZe2kuvc", title: "Veux-tu vivre libre ? Voici ce qu'il te faut savoir", theme: "Combat spirituel", publishedAt: "2025-11-10", durationSeconds: 2700, contentType: "predication" },
      { id: "m-wafo-2", videoId: "4rfsm-ggHpk", title: "Une révélation sur la justice de Dieu qui va révolutionner ta vie", theme: "Foi", publishedAt: "2025-10-04", durationSeconds: 2700, contentType: "predication" },
  ...
  },
  {
    ...
    messages: [
      { id: "m-yvan-1", videoId: "sTO92Vtwc_Q", title: "J19 — 21 jours de jeûne & prières", theme: "Prière", publishedAt: "2026-06-24", durationSeconds: 2700, contentType: "predication" },
      { id: "m-yvan-2", videoId: "uC47pH-Q3J0", title: "Soirée du Saint-Esprit", theme: "Foi", publishedAt: "2026-05-22", durationSeconds: 2700, contentType: "predication" },
      { id: "m-yvan-3", videoId: "kN67LifFeAg", title: "La grande désillusion à venir : l'absence de l'image", theme: "Combat spirituel", publishedAt: "2026-06-07", durationSeconds: 2700, contentType: "predication" },
      ...
      { id: "m-yvan-6", videoId: "C6sSw6IkMP0", title: "Planifie ton caractère, ta consécration et ta prospérité en 2025", theme: "Finances", publishedAt: "2025-01-05", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  {
    id: "yves-castanou",
    ...
    messages: [
      { id: "m-yves-1", videoId: "fPqcyDleKjI", title: "Temps d'enseignement — CIC2026 / Jour 4", theme: "Foi", publishedAt: "2026-07-10", durationSeconds: 2700, contentType: "predication" },
      { id: "m-yves-2", videoId: "HwezWNIXv1c", title: "Le réveil pour la royauté — Camp Impact Conférence 2026", theme: "Foi", publishedAt: "2026-07-09", durationSeconds: 2700, contentType: "predication" },
      { id: "m-yves-3", videoId: "-gJd5Ptzw5o", title: "Croyant ou disciple de Christ ?", theme: "Foi", publishedAt: "2026-01-04", durationSeconds: 2700, contentType: "predication" },
      { id: "m-yves-4", videoId: "TxpvORtSUw8", title: "Les ingrédients d'une vie de prière sacrificielle", theme: "Prière", publishedAt: "2024-10-18", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  {
    id: "mohammed-sanogo",
    ...
    messages: [
      { id: "m-sanogo-4", videoId: "8ZWWaYAUjDk", title: "Les 7 royaumes de Satan (1ère partie)", theme: "Combat spirituel", publishedAt: "2026-03-21", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-5", videoId: "ZEFUmiwNGhg", title: "Comment voir la face de Dieu", theme: "Prière", publishedAt: "2026-02-09", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-6", videoId: "50cuZlz-W4c", title: "Réussir 2026 — 7 jours de jeûne et prières (Jour 4)", theme: "Prière", publishedAt: "2026-02-05", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-7", videoId: "tuwJiJM5idY", title: "Matinale des miracles", theme: "Guérison", publishedAt: "2026-01-17", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-1", videoId: "-TfhDxbX4Ck", title: "L'onction pour faire des disciples", theme: "Foi", publishedAt: "2025-06-12", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-2", videoId: "CNmUzmaQPGk", title: "Lâchez prise et trouvez la paix", theme: "Guérison", publishedAt: "2023-09-21", durationSeconds: 2700, contentType: "predication" },
      { id: "m-sanogo-3", videoId: "zwHIrok0TlE", title: "Un remède puissant pour une vie abondante en Christ", theme: "Guérison", publishedAt: "2023-07-11", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  {
    id: "chris-ndikumana",
    ...
    messages: [
      { id: "m-chris-1", videoId: "K0sonIZMRHM", title: "Conférence Pentecôte 2026 — Soirée de feu et de puissance", theme: "Combat spirituel", publishedAt: "2026-05-24", durationSeconds: 2700, contentType: "predication" },
      { id: "m-chris-2", videoId: "tM73S3KrvlI", title: "Kanguka Abidjan 2024 — Jésus a gagné", theme: "Foi", publishedAt: "2024-12-07", durationSeconds: 2700, contentType: "predication" },
      { id: "m-chris-3", videoId: "yEI2G6Oythc", title: "Repose-toi en Christ", theme: "Guérison", publishedAt: "2025-07-26", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  ...
  // --- ANGLOPHONES ---
  {
    ...
    messages: [
      { id: "m-selman-1", videoId: "9WPdalJYx38", title: "Worship & Warfare Service — The Koinonia Experience", theme: "Combat spirituel", publishedAt: "2026-04-19", durationSeconds: 2700, contentType: "predication" },
      { id: "m-selman-2", videoId: "nfes9VHzUgU", title: "April 2025 Miracle Service", theme: "Guérison", publishedAt: "2025-04-27", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  {
    id: "jerry-eze",
    ...
    messages: [
      { id: "m-jerry-1", videoId: "kEwRVpiPWgY", title: "NSPPD — Morning Prophetic Prayers & Declarations", theme: "Prière", publishedAt: "2026-06-15", durationSeconds: 2700, contentType: "predication" },
      { id: "m-jerry-2", videoId: "l0v_npx27bM", title: "NSPPD Live — Prophetic Prayers & Declarations", theme: "Prière", publishedAt: "2026-06-16", durationSeconds: 2700, contentType: "predication" },
    ],
  },
  {
    id: "eno-jerry",
    ...
    messages: [
      { id: "m-eno-1", videoId: "gWLCxy3G0ps", title: "What God wants from men and women in relationship", theme: "Couple & Famille", publishedAt: "2020-10-24", durationSeconds: 2700, contentType: "predication" },
      { id: "m-eno-2", videoId: "0vi2gulHOdc", title: "Memorize with me — Oil of gladness (Psalm 45:7)", theme: "Foi", publishedAt: "2025-06-09", durationSeconds: 2700, contentType: "predication" },
    ],
  },
];
